...
// Variants for the button styles
...
// Define a type for possible component types
type ButtonComponent = React.ElementType<ButtonProps>;

const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, ...props }, ref) => {
    const Comp: ButtonComponent = asChild ? Slot : "button";
    return (
      <Comp
