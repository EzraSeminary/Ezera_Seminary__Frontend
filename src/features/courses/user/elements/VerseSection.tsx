  ...
  return (
    <div className="w-full flex flex-col items-center mt-4">
      ...
      {activeIndex !== null && (
        ...
        >
          <div
          className="w-auto max-w-[70%] mx-auto flex items-start justify-center text-center bg-secondary-6 bg-opacity-85 shadow-2xl px-4 py-6 text-accent-5 text-lg hover:bg-secondary-5 hover:bg-opacity-40 transition-all rounded-lg my-2 border border-accent-6 relative"
        >
